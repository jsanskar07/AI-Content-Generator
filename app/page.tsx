  ...
  return (
    ...
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50 ">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8 lg:ml-20 lg:mr-20">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  ...
                  >
                    {/* <UserButton/> <span clase="-msName='ml-2'>{user?.fullName}</span> */}
                    {user === null || user === undefined
                      ? <SignInButton /> :
                      <div className='flex items-center'>
                        <UserButton /><span className='ml-4'>{user?.fullName}</span>
                      </div>
                    }
                  </div>
                </div>
      ...
      <section className='pt-60 relative overflow-hidden'>
        <div className='container'>
          ...
          <div className='mx-auto flex max-w-5xl flex-col items-center'>
            <div className='z-10 flex flex-col items-center gap-6 text-center'>
              ...
              <Link href="/dashboard"><Button className='px-5 py-6 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-primary lg:px-10 rounded-xl hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'>Get Started</Button></Link>
              ...
              <div className='mt-20 flex flex-col items-center gap-4'>
                ...
                <div className='flex flex-wrap items-center justify-center gap-4'>
                  ...
                  >
                    <img
                      src='https://www.shadcnblocks.com/images/block/logos/nextjs-small.svg'
                      alt='company logo'
                      className='h-6 saturate-0 transition-all group-hover:saturate-100'
                    />
                  </a>
